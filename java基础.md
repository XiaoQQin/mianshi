...
[3. 关于hashMap](#3-关于hashMap)  
  - [3.1 hashMap的结构](#31-hashMap的结构)  
  - [3.2 怎么确定桶的索引](#32-怎么确定桶的索引)  
  - [3.3 hashMap的扩容机制](#33-hashMap的扩容机制)  
  - [3.4 使用ConcurrentHashMap](#34-使用ConcurrentHashMap)  
[4. 关于ArrayList和LinkedList](#4-关于ArrayList和LinkedList)  
[5. java抽象类和接口](#5-java抽象类和接口)  
[6. jdk1.8相对于1.7有什么变化](#6-jdk1.8相对于1.7有什么变化)  
[7. java内部类](#7-java内部类)  
[8. BIO、NIO和AIO的区别](#8-BIO、NIO和AIO的区别)
